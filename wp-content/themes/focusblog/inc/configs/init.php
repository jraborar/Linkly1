...
function thrive_enqueue_scripts() {
	...
	wp_register_script( 'jquerytouchswipe', get_template_directory_uri() . '/js/jquery.touchswipe.min.js', array( 'jquery' ), "", true );
...
function thrive_admin_notice() {
	...
	<div class="update-nag">
		<p>
			<?php if ( function_exists( 'thrive_product_manager' ) ) : ?>
				<?php _e( 'Your theme has successfully been activated! Next step, go to Thrive Product Manager and license your theme: ', 'thrive' ); ?>
				<a href="<?php echo admin_url(); ?>admin.php?page=tve_dash_license_manager_section">
			...
			<?php else : ?>
				...
				<a href="<?php echo admin_url(); ?>admin.php?page=tve_dash_license_manager_section"><?php echo __( 'License Activation', 'thrive' ) ?></a>
			<?php endif; ?>
