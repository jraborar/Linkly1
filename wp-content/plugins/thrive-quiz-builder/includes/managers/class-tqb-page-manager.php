...
class TQB_Page_Manager {
	...
	public function get_page_display_html( $points ) {
		...
		if ( ( $page->post_type == Thrive_Quiz_Builder::QUIZ_STRUCTURE_ITEM_RESULTS || $page->post_type == Thrive_Quiz_Builder::QUIZ_STRUCTURE_ITEM_OPTIN ) && $points['user_points'] != null ) {
