...
return array(
	...
	'quiz_settings'                      => __( 'Quiz settings', Thrive_Quiz_Builder::T ),
	...
	'clone_quiz_success'                 => __( 'The quiz was cloned', Thrive_Quiz_Builder::T ),
	'clone_quiz_error'                   => __( 'The quiz could not be duplicated', Thrive_Quiz_Builder::T ),
	'copy'                               => __( 'Copy', Thrive_Quiz_Builder::T ),
	'more_quizzes'                       => __( 'More Quizzes', Thrive_Quiz_Builder::T ),
	'load_more'                          => __( 'Load %d More', Thrive_Quiz_Builder::T ),
	'search_quizzes'                     => __( 'Search Quizzes', Thrive_Quiz_Builder::T ),
	'highlight_and_feedback_text'        => __( 'How long should the highlight and feedback be displayed for?', Thrive_Quiz_Builder::T ),
	'feedback_text'                      => __( 'How long should the highlight be displayed for?', Thrive_Quiz_Builder::T ),
	'results_page'                       => __( 'Results Page', Thrive_Quiz_Builder::T ),
	'redirect_settings'                  => __( 'Redirect Settings', Thrive_Quiz_Builder::T ),
	'redirect_link'                      => array(
		'search_content'      => __( 'Search content', Thrive_Quiz_Builder::T ),
		'add_url'             => __( 'Add URL', Thrive_Quiz_Builder::T ),
		'local_type_label'    => __( 'Redirect to content on site', Thrive_Quiz_Builder::T ),
		'external_type_label' => __( 'Redirect to external URL', Thrive_Quiz_Builder::T ),
		'errors'              => array(
			'invalid_lower_bound'                     => __( 'Invalid Lower Bound', Thrive_Quiz_Builder::T ),
			'lower_bound_lower_than_minimum_result'   => __( 'Lower Bound cannot be lower than Minimum Result', Thrive_Quiz_Builder::T ),
			'lower_bound_greater_than_maximum_result' => __( 'Lower Bound cannot be greater than Maximum Result', Thrive_Quiz_Builder::T ),
			'lower_bound_greater_than_upper_bound'    => __( 'Lower Bound cannot be greater than Upper Bound', Thrive_Quiz_Builder::T ),
			'invalid_upper_bound'                     => __( 'Invalid Upper Bound', Thrive_Quiz_Builder::T ),
			'upper_bound_lower_than_minimum_result'   => __( 'Upper Bound cannot be lower than Minimum Result', Thrive_Quiz_Builder::T ),
			'upper_bound_greater_than_maximum_result' => __( 'Upper Bound cannot be greater than Maximum Result', Thrive_Quiz_Builder::T ),
			'upper_bound_lower_than_lower_bound'      => __( 'Upper bound cannot be lower than Lower Bound', Thrive_Quiz_Builder::T ),
			'url_not_set'                             => __( 'URL not set', Thrive_Quiz_Builder::T ),
			'invalid_url'                             => __( 'Invalid URL. It should be something like this: https://www.thrivethemes.com', Thrive_Quiz_Builder::T ),
			'no_content'                              => __( 'No content set as target', Thrive_Quiz_Builder::T ),
		),
	),
	'redirect_message'                   => array(
		'title'   => __( 'Quiz Completed!', Thrive_Quiz_Builder::T ),
		'message' => __( 'Redirecting you to the best result', Thrive_Quiz_Builder::T ),
		'errors'  => array(
			'invalid_title'    => __( 'Invalid message title', Thrive_Quiz_Builder::T ),
			'invalid_text'     => __( 'Invalid message text', Thrive_Quiz_Builder::T ),
			'invalid_duration' => __( 'Invalid duration! Please enter a value between 1 and 10 seconds.', Thrive_Quiz_Builder::T ),
		),
	),
	'create_result_page'                 => __( 'Step 4/4: Create a result page.', Thrive_Quiz_Builder::T ),
	'create_redirect_link'               => __( 'Step 4/4: Create at least one redirect link.', Thrive_Quiz_Builder::T ),
	'not_supported_video_tag'            => __( 'Not supported video tag', Thrive_Quiz_Builder::T ),
	'category_title_required'            => __( 'Category title is required!', Thrive_Quiz_Builder::T ),
	'category_title_too_long'            => __( 'Category title must not exceed 255 characters!', Thrive_Quiz_Builder::T ),
);
