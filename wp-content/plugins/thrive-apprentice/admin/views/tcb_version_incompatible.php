...
<div class="tve-ult-notice-overlay">
	<div id="tve_ult_license_notice">
		<img src="<?php echo TVA_Const::plugin_url( 'admin/img/placeholder-logo.png' ) ?>" width="250">

		<p style="margin: 20px 0">
			<?php echo __( "It looks like you have Thrive Architect installed, but it's not compatible with this version of Thrive Apprentice. Thrive Apprentice uses Thrive Architect to edit various pieces of content.
To be able to use this feature, please make sure you have the latest versions for both plugins by clicking on the following link and checking for updates:", TVA_Const::T ) ?>
		</p>

		<p style="margin: 0;">
			<a class="tve-license-link"
			   href="<?php echo network_admin_url( 'plugins.php' ); ?>"><?php echo __( 'Manage plugins', TVA_Const::T ) ?></a>
		</p>
	</div>
</div>
<style type="text/css">
