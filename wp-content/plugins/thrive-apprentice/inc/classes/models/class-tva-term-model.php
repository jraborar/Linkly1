...
class TVA_Term_Model extends TVA_Model {
	...
	public function is_protected_by_sendowl() {
		return array_key_exists( 'sendowl', $this->membership_ids ) && ! empty( $this->membership_ids['sendowl'] )
		       || array_key_exists( 'sendowl', $this->bundle_ids ) && ! empty( $this->bundle_ids['sendowl'] );
	}
