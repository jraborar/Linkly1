 ...
 */
function tve_tho_dashboard_loaded() {
...
function tho_update_checker() {
	...
	add_filter( 'puc_request_info_result-thrive-headline-optimizer', 'tho_set_product_icon' );
}
...
function tho_set_product_icon( $info ) {
	$info->icons['1x'] = THO_ADMIN_URL . '/img/tho-logo-icon.png';
