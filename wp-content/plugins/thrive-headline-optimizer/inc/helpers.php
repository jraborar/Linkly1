...
function tho_test_item_beat_original( $variation_engagement_rate, $variation_views, $control_engagement_rate, $control_views, $suffix = '%' ) {
	...
	$variation_engagement_rate = floatval( $variation_engagement_rate ) / 100;
	$control_engagement_rate   = floatval( $control_engagement_rate ) / 100;
...
function tho_ignore_log() {
	return current_user_can( 'edit_posts' ) || is_feed();
}
